...
dragula([$('1'), $('2'), $('3'), $('4'), $('5'), $('6')], { revertOnSpill: true });

//dragula([document.getElementById('51')]);
//dragula([document.getElementById('52')]);
...
//this function gives error on Void Linux - musl ???
}
